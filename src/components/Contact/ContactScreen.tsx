...
const ContactScreen = () => {
  ...
  return (
    <>
      ...
      {/* <div className="hero h-80 pt-16 overflow-hidden bg-gradient-to-r from-pink-700 to-pink-600 text-primary-content"> */}
      {/* background by SVGBackgrounds.com */}
      <div
        className="hero h-80 pt-16 overflow-hidden text-primary-content opacity-90"
        style={{
      ...
      >
        <div className="text-center hero-content">
          <div className="max-w-xl">
            <h1 className="mb-5 text-4xl sm:text-6xl lg:text-7xl font-extrabold">Contacto</h1>
            {/* <p className="mb-5">Escrime</p> */}
          </div>
        </div>
      </div>
      ...
      <div className="bg-base-200 text-gray-100 px-8 py-20">
        <div className="text-center w-full">
          ...
          {/* <div className="divider my-20">
            {' '}
            <span className="text-base-content">o</span>
          </div>
          <span className="text-center text-base-content text-xl">
            Háblanos sobre tu producto o servicio
          </span> */}
        </div>
        {/* <div className="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
          <div className="flex flex-col justify-between">
            <div>
              <h2 className="text-4xl lg:text-5xl font-bold leading-tight">¡Hablemos de todo!</h2>
              <div className="text-gray-700 mt-8">
                ¿Odias los formularios? Envíanos un{' '}
                <span className="underline">correo electrónico</span> en su lugar.
              </div>
            </div>
          ...
          <div className="">
            <div className="form-control">
              <label className="label ">
                <span className="label-text uppercase font-bold text-gray-600">
                  Nombre Completo
                </span>
              </label>
              <input type="text" placeholder="Nombre Completo" className="input input-bordered" />
            </div>
            ...
            <div className="form-control">
              <label className="label ">
                <span className="label-text uppercase font-bold text-gray-600">Mensaje</span>
              </label>
              <textarea
            ...
            <div className="mt-8">
              ...
              <button className="btn btn-primary btn-lg block w-full">Enviar Mensaje</button>
            </div>
          </div>
        </div> */}
      </div>
